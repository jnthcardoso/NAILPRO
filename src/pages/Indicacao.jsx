...
const s = {
  ...
  card: {
    background: 'rgba(255, 255, 255, 0.03)', borderRadius: 24, padding: '16px 24px',
  ...
  iconWrap: { width: 44, height: 44, borderRadius: '50%', background: 'var(--gold, #E6C260)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '4px auto 8px', boxShadow: '0 8px 20px rgba(230,194,96,0.3)' },
  titulo: { fontFamily: "'Instrument Serif', serif", fontStyle: 'italic', fontSize: 25, fontWeight: 400, color: '#fff', textAlign: 'center', margin: 0 },
  sub: { textAlign: 'center', fontSize: 12.5, color: 'rgba(255,255,255,0.55)', marginTop: 2, marginBottom: 14, fontFamily: "'Instrument Serif', serif", fontStyle: 'italic' },
  premios: { display: 'flex', alignItems: 'stretch', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: '12px 10px', marginBottom: 14 },
  premio: { flex: 1, textAlign: 'center', padding: '0 8px' },
  premioDiv: { width: 1, background: 'rgba(255,255,255,0.1)' },
  premioValor: { fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 26, fontWeight: 800, color: 'var(--gold, #E6C260)', lineHeight: 1 },
  premioTxt: { fontSize: 11.5, color: 'rgba(255,255,255,0.75)', marginTop: 4, lineHeight: 1.35 },
  passos: { display: 'flex', flexDirection: 'column', gap: 7, marginBottom: 14 },
  ...
  btnPrincipal: { width: '100%', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: 'var(--gold, #E6C260)', color: 'var(--brand-dark-bg, #170D14)', border: 'none', borderRadius: 14, padding: '12px', fontSize: 15, fontWeight: 800, cursor: 'pointer', fontFamily: "'Bricolage Grotesque', sans-serif", boxShadow: '0 8px 24px rgba(0,0,0,0.18)' },
