...
const s = {
  ...
  header: { background: 'var(--pink, #8B2655)', padding: '16px 20px 13px', color: 'white', textAlign: 'center', boxShadow: '0 4px 20px rgba(var(--pink-rgb),0.15)' },
  ...
  card: { background: 'white', borderRadius: 18, padding: '16px 16px', boxShadow: '0 4px 24px rgba(var(--pink-rgb),0.08)', display: 'flex', flexDirection: 'column', gap: 10, border: '1px solid var(--border)' },
  ...
  btnWhats: { display: 'block', width: '100%', boxSizing: 'border-box', textAlign: 'center', background: 'var(--whatsapp)', color: 'white', borderRadius: 12, padding: '13px', fontSize: 15, fontWeight: 700, textDecoration: 'none', marginTop: 4, fontFamily: "'Bricolage Grotesque', sans-serif" },
