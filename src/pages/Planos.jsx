  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.toggleWrap}>
        ...
        {/* "sem juros" é verdade enquanto o parcelamento no Asaas estiver SEM repasse de
            juros ao cliente. Se mudar essa config no Asaas, remover "sem juros" desta tela. */}
        {ciclo === 'anual' && (
          <div style={s.anualNota}>💳 Parcele em até 12× sem juros no cartão · acesso garantido por 12 meses · cancele quando quiser</div>
        )}
        {ciclo === 'mensal' && (
      ...
      <div style={s.segurancaRow}>
        ...
        <strong>Asaas</strong>
        <span>· Cartão de crédito · anual em até 12× sem juros · mensal com renovação automática</span>
      </div>
