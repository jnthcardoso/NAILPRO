...
function buildWhatsAppConfirm(ag) {
  ...
  let msg = `Olá ${nome}! Confirmando seu horário para ${dataFmt} às ${horario} - ${ag.servico}. Pode confirmar presença? 💅`
  ...
  if (codigo) {
    msg += `\n\nToque para confirmar seu horário: ${window.location.origin}/c/${codigo}`
  }
